...
import static org.apache.camel.language.csimple.CSimpleHelper.bean;

@Component
public class EventRoute extends RouteBuilder {

    //@Value("${routes.iot_data_aquisition.base-rest-path}")
    private String baseRestPath = "http://localhost:8080/";
